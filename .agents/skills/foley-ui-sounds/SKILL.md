...
Read [the integration guide](../../../documentation/docs/ui-sounds.md) and the affected feature. The implementation lives in [UiSounds](../../../src/TemplateV4.Angular/src/app/core/ui-sounds.ts); [Notifications](../../../modules/Bundled/Notifications/Frontend/notifications.ts) already supplies success/error sounds for toasts.
