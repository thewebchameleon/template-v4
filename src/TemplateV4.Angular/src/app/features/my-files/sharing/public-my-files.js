...
import { MyFilesDemoBanner } from '../files/my-files-demo-banner';
...
import { MyFileName } from '../files/my-files-components';
...
const _c0 = () => [];
function PublicMyFilesPage_Conditional_11_Template(rf, ctx) { if (rf & 1) {
    const _r1 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 9);
    i0.ɵɵlistener("click", function PublicMyFilesPage_Conditional_11_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.query.set({ folder: null, page: 1 })); });
    i0.ɵɵtext(1);
    i0.ɵɵpipe(2, "t");
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵlistener("ngModelChange", function PublicMyFilesPage_Conditional_11_Template_input_ngModelChange_7_listener($event) { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.search.update($event)); });
    i0.ɵɵelementEnd();
    i0.ɵɵcontrolCreate();
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(8, "app-page-state", 7);
    i0.ɵɵlistener("retry", function PublicMyFilesPage_Conditional_11_Template_app_page_state_retry_8_listener() { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.load()); });
    i0.ɵɵelementStart(9, "app-data-table", 13);
    i0.ɵɵpipe(10, "t");
    i0.ɵɵpipe(11, "t");
    i0.ɵɵlistener("sortChange", function PublicMyFilesPage_Conditional_11_Template_app_data_table_sortChange_9_listener($event) { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.sort($event)); });
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(12, "app-list-pager", 14);
    i0.ɵɵlistener("pageChange", function PublicMyFilesPage_Conditional_11_Template_app_list_pager_pageChange_12_listener($event) { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.query.set({ page: $event })); });
    i0.ɵɵelementEnd()();
} if (rf & 2) {
...
function PublicMyFilesPage_Conditional_12_Template(rf, ctx) { if (rf & 1) {
    const _r3 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 15);
    i0.ɵɵlistener("click", function PublicMyFilesPage_Conditional_12_Template_button_click_0_listener() { const file_r4 = i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.download(file_r4)); });
    i0.ɵɵtext(1);
    i0.ɵɵpipe(2, "t");
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
export class PublicMyFilesPage {
    ...
    base = `${this.runtime.apiUrl}/api/v1/auth/my-files/public`;
    columns = computed(() => {
        this.i18n.culture();
    ...
    static ɵfac = function PublicMyFilesPage_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || PublicMyFilesPage)(); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PublicMyFilesPage, selectors: [["app-public-my-files"]], decls: 13, vars: 9, consts: [["title", "sharedFiles", "description", "publicFilesHelp"], [3, "enabled", "minutes"], ["hlmCard", ""], ["hlmCardHeader", ""], ["hlmCardTitle", ""], ["hlmCardDescription", ""], ["hlmCardContent", ""], [3, "retry", "state", "refreshError"], ["hlmBtn", ""], ["hlmBtn", "", "variant", "outline", 3, "click"], ["hlmField", "", 1, "my-4"], ["hlmFieldLabel", "", "for", "public-search"], ["hlmInput", "", "id", "public-search", "maxlength", "120", 3, "ngModelChange", "ngModel"], [3, "sortChange", "columns", "data", "loading", "loadingText", "emptyText", "sortColumn", "sortDirection"], [3, "pageChange", "total", "page", "size"], ["hlmBtn", "", 3, "click"]], template: function PublicMyFilesPage_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelement(0, "app-page-header", 0)(1, "app-my-files-demo-banner", 1);
            ...
            i0.ɵɵlistener("retry", function PublicMyFilesPage_Template_app_page_state_retry_10_listener() { return ctx.load(); });
            i0.ɵɵconditionalCreate(11, PublicMyFilesPage_Conditional_11_Template, 13, 24)(12, PublicMyFilesPage_Conditional_12_Template, 3, 4, "button", 8);
            i0.ɵɵelementEnd()()();
        } if (rf & 2) {
            let tmp_6_0;
            i0.ɵɵadvance();
        ...
        } }, dependencies: [i1.PageHeader, i1.PageState, i1.ListPager, i2.FormsModule, i2.DefaultValueAccessor, i2.NgControlStatus, i2.MaxLengthValidator, i2.NgModel, i3.HlmButton, i4.HlmCard, i4.HlmCardContent, i4.HlmCardDescription, i4.HlmCardHeader, i4.HlmCardTitle, i5.HlmField, i5.HlmFieldLabel, i6.HlmInput, DataTable, MyFilesDemoBanner, i7.Translate], encapsulation: 2 });
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(PublicMyFilesPage, [{
        type: Component,
        args: [{
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(PublicMyFilesPage, { className: "PublicMyFilesPage", filePath: "src/app/features/public-my-files.ts", lineNumber: 73 }); })();
