...
function FileQuotaEditor_Conditional_7_Conditional_20_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind1(2, 1, "fileStorageDemoExpiryValidation"));
} }
function FileQuotaEditor_Conditional_7_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance(4);
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind1(15, 18, "fileStorageDemoExpiry"));
    i0.ɵɵadvance(2);
    ...
    i0.ɵɵcontrol();
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind1(19, 20, "fileStorageDemoExpiryHelp"));
    i0.ɵɵadvance(2);
...
export class FileQuotaEditor {
    ...
    async load() {
        const loaded = await this.data.load((signal) => this.api.get(this.owner() ? `file-storage/admin/users/${this.owner()}` : 'file-storage/admin/settings', {}, signal));
        if (!loaded)
            return;
    ...
    async save() {
        ...
        try {
            ...
            await this.api.post(this.owner() ? `file-storage/admin/users/${this.owner()}/quota` : 'file-storage/admin/settings', this.owner()
                ? { quotaBytes: bytes }
                : {
            ...
            this.toast.success(this.owner() ? 'quotaSaved' : 'fileStorageSettingsSaved');
            await this.load();
            this.saved.emit();
        }
        catch {
