export const customerDictionary: Record<string, [string, string]> = {
  ...
  organisationCountry: ['Country', 'Land'],
  organisationPrimaryContactNumber: ['Primary contact number', 'Primêre kontaknommer'],
  phoneCountryCode: ['Phone country code', 'Telefoonlandkode'],
  searchCountries: ['Search', 'Soek'],
  noCountriesFound: ['No countries found.', 'Geen lande gevind nie.'],
  countryInvalid: [
    'Choose a country from the list or leave the field empty.',
    'Kies ’n land uit die lys of laat die veld leeg.',
  ],
  phoneInvalid: [
    'Enter a valid phone number for the selected country code.',
    'Voer ’n geldige telefoonnommer vir die gekose landkode in.',
  ],
