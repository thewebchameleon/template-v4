import { fileIconName, canMoveFolder, filterVisibleFileGroups } from './my-files-ui';
...
import { filterVisibleFileFolders } from './my-files-ui';
...
function MyFileActions_For_2_Template(rf, ctx) { if (rf & 1) {
    const _r1 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 2);
    i0.ɵɵpipe(1, "t");
    i0.ɵɵpipe(2, "t");
    i0.ɵɵlistener("click", function MyFileActions_For_2_Template_button_click_0_listener($event) { const action_r2 = i0.ɵɵrestoreView(_r1).$implicit; $event.stopPropagation(); return i0.ɵɵresetView(action_r2.run()); });
...
function MyFileName_Conditional_1_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "ng-icon", 1);
} }
function MyFileName_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "app-my-file-icon", 2);
} if (rf & 2) {
    const ctx_r0 = i0.ɵɵnextContext();
    i0.ɵɵproperty("file", ctx_r0.file());
} }
function MyFileName_Conditional_4_Template(rf, ctx) { if (rf & 1) {
    const _r2 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 8);
    i0.ɵɵlistener("click", function MyFileName_Conditional_4_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r2); const ctx_r0 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r0.open()?.()); });
...
function MyFileName_Conditional_5_Template(rf, ctx) { if (rf & 1) {
...
function MyFileName_Conditional_8_Template(rf, ctx) { if (rf & 1) {
...
function MyFileName_Conditional_9_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span", 7);
    i0.ɵɵtext(1);
    i0.ɵɵpipe(2, "t");
    i0.ɵɵelementEnd();
...
function MyFilesActionDialog_hlm_alert_dialog_content_1_Conditional_7_Template(rf, ctx) { if (rf & 1) {
    const _r1 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "form", 5);
    i0.ɵɵlistener("ngSubmit", function MyFilesActionDialog_hlm_alert_dialog_content_1_Conditional_7_Template_form_ngSubmit_0_listener() { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r1.submitCreate()); });
    i0.ɵɵelementStart(1, "div", 6)(2, "label", 7);
    i0.ɵɵtext(3);
    i0.ɵɵpipe(4, "t");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(5, "input", 8);
    i0.ɵɵtwoWayListener("ngModelChange", function MyFilesActionDialog_hlm_alert_dialog_content_1_Conditional_7_Template_input_ngModelChange_5_listener($event) { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(2); i0.ɵɵtwoWayBindingSet(ctx_r1.folderName, $event) || (ctx_r1.folderName = $event); return i0.ɵɵresetView($event); });
    i0.ɵɵelementEnd();
    i0.ɵɵcontrolCreate();
    i0.ɵɵelementEnd();
...
function MyFilesActionDialog_hlm_alert_dialog_content_1_Conditional_8_hlm_select_content_7_For_2_Template(rf, ctx) { if (rf & 1) {
...
function MyFilesActionDialog_hlm_alert_dialog_content_1_Conditional_8_hlm_select_content_7_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "hlm-select-content");
    i0.ɵɵrepeaterCreate(1, MyFilesActionDialog_hlm_alert_dialog_content_1_Conditional_8_hlm_select_content_7_For_2_Template, 2, 3, "hlm-select-item", 16, _forTrack1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function MyFilesActionDialog_hlm_alert_dialog_content_1_Conditional_8_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtwoWayListener("valueChange", function MyFilesActionDialog_hlm_alert_dialog_content_1_Conditional_8_Template_hlm_select_valueChange_4_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(2); i0.ɵɵtwoWayBindingSet(ctx_r1.moveTarget, $event) || (ctx_r1.moveTarget = $event); return i0.ɵɵresetView($event); });
    i0.ɵɵelementStart(5, "hlm-select-trigger", 12);
    i0.ɵɵelement(6, "hlm-select-value");
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(7, MyFilesActionDialog_hlm_alert_dialog_content_1_Conditional_8_hlm_select_content_7_Template, 3, 0, "hlm-select-content", 13);
    i0.ɵɵelementEnd()();
    ...
    i0.ɵɵlistener("click", function MyFilesActionDialog_hlm_alert_dialog_content_1_Conditional_8_Template_button_click_12_listener() { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r1.move.emit(ctx_r1.moveTarget)); });
    i0.ɵɵtext(13);
    i0.ɵɵpipe(14, "t");
    i0.ɵɵelementEnd()();
} if (rf & 2) {
...
function MyFilesActionDialog_hlm_alert_dialog_content_1_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵtext(6);
    i0.ɵɵelementEnd()();
    i0.ɵɵconditionalCreate(7, MyFilesActionDialog_hlm_alert_dialog_content_1_Conditional_7_Template, 13, 15, "form", 4)(8, MyFilesActionDialog_hlm_alert_dialog_content_1_Conditional_8_Template, 15, 15);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function MyFilesTree_Conditional_5_Template(rf, ctx) { if (rf & 1) {
    const _r1 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 8);
    i0.ɵɵlistener("click", function MyFilesTree_Conditional_5_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.load()); });
    i0.ɵɵtext(1);
    i0.ɵɵpipe(2, "t");
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function MyFilesTree_For_8_ng_template_9_Template(rf, ctx) { if (rf & 1) {
    const _r5 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "hlm-dropdown-menu")(1, "button", 14);
    i0.ɵɵlistener("triggered", function MyFilesTree_For_8_ng_template_9_Template_button_triggered_1_listener() { i0.ɵɵrestoreView(_r5); const ctx_r1 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r1.beginRootFolderCreation()); });
    i0.ɵɵtext(2);
    i0.ɵɵpipe(3, "t");
    i0.ɵɵelementEnd()();
} if (rf & 2) {
...
function MyFilesTree_For_8_Conditional_11_For_4_Conditional_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "span", 18);
} }
function MyFilesTree_For_8_Conditional_11_For_4_Conditional_9_Template(rf, ctx) { if (rf & 1) {
    const _r9 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 24);
    i0.ɵɵpipe(1, "t");
    i0.ɵɵlistener("click", function MyFilesTree_For_8_Conditional_11_For_4_Conditional_9_Template_button_click_0_listener($event) { i0.ɵɵrestoreView(_r9); const ctx_r1 = i0.ɵɵnextContext(4); return i0.ɵɵresetView(ctx_r1.rememberContextTrigger($event)); });
...
function MyFilesTree_For_8_Conditional_11_For_4_ng_template_10_Template(rf, ctx) { if (rf & 1) {
    const _r11 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "hlm-dropdown-menu")(1, "button", 14);
    i0.ɵɵlistener("triggered", function MyFilesTree_For_8_Conditional_11_For_4_ng_template_10_Template_button_triggered_1_listener() { i0.ɵɵrestoreView(_r11); const node_r8 = i0.ɵɵnextContext().$implicit; const ctx_r1 = i0.ɵɵnextContext(3); return i0.ɵɵresetView(ctx_r1.beginContextAction(node_r8.file, "move")); });
    i0.ɵɵtext(2);
    i0.ɵɵpipe(3, "t");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(4, "button", 14);
    i0.ɵɵlistener("triggered", function MyFilesTree_For_8_Conditional_11_For_4_ng_template_10_Template_button_triggered_4_listener() { i0.ɵɵrestoreView(_r11); const node_r8 = i0.ɵɵnextContext().$implicit; const ctx_r1 = i0.ɵɵnextContext(3); return i0.ɵɵresetView(ctx_r1.beginContextAction(node_r8.file, "create")); });
    i0.ɵɵtext(5);
    i0.ɵɵpipe(6, "t");
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵpipe(9, "t");
    i0.ɵɵlistener("triggered", function MyFilesTree_For_8_Conditional_11_For_4_ng_template_10_Template_button_triggered_8_listener() { i0.ɵɵrestoreView(_r11); const node_r8 = i0.ɵɵnextContext().$implicit; const ctx_r1 = i0.ɵɵnextContext(3); return i0.ɵɵresetView(ctx_r1.deleteFolder(node_r8.file)); });
    i0.ɵɵtext(10);
    i0.ɵɵpipe(11, "t");
    i0.ɵɵelementEnd()();
} if (rf & 2) {
...
function MyFilesTree_For_8_Conditional_11_For_4_Template(rf, ctx) { if (rf & 1) {
    const _r6 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "li", 16);
    i0.ɵɵanimateEnter("sidebar-item-enter");
    i0.ɵɵlistener("contextmenu", function MyFilesTree_For_8_Conditional_11_For_4_Template_li_contextmenu_0_listener($event) { i0.ɵɵrestoreView(_r6); const ctx_r1 = i0.ɵɵnextContext(3); return i0.ɵɵresetView(ctx_r1.rememberContextTrigger($event)); })("keydown", function MyFilesTree_For_8_Conditional_11_For_4_Template_li_keydown_0_listener($event) { i0.ɵɵrestoreView(_r6); const ctx_r1 = i0.ɵɵnextContext(3); return i0.ɵɵresetView(ctx_r1.rememberContextTriggerKey($event)); });
    i0.ɵɵconditionalCreate(1, MyFilesTree_For_8_Conditional_11_For_4_Conditional_1_Template, 3, 5, "button", 17)(2, MyFilesTree_For_8_Conditional_11_For_4_Conditional_2_Template, 1, 0, "span", 18);
    i0.ɵɵelementStart(3, "a", 19);
    i0.ɵɵlistener("click", function MyFilesTree_For_8_Conditional_11_For_4_Template_a_click_3_listener() { i0.ɵɵrestoreView(_r6); const ctx_r1 = i0.ɵɵnextContext(3); return i0.ɵɵresetView(ctx_r1.closeMobile()); })("dragstart", function MyFilesTree_For_8_Conditional_11_For_4_Template_a_dragstart_3_listener($event) { const node_r8 = i0.ɵɵrestoreView(_r6).$implicit; const group_r4 = i0.ɵɵnextContext(2).$implicit; const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.startDrag($event, node_r8.file, group_r4.id)); })("dragend", function MyFilesTree_For_8_Conditional_11_For_4_Template_a_dragend_3_listener() { i0.ɵɵrestoreView(_r6); const ctx_r1 = i0.ɵɵnextContext(3); return i0.ɵɵresetView(ctx_r1.endDrag()); })("dragover", function MyFilesTree_For_8_Conditional_11_For_4_Template_a_dragover_3_listener($event) { const node_r8 = i0.ɵɵrestoreView(_r6).$implicit; const group_r4 = i0.ɵɵnextContext(2).$implicit; const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.dragOver($event, node_r8.file.id, group_r4.id)); })("dragleave", function MyFilesTree_For_8_Conditional_11_For_4_Template_a_dragleave_3_listener() { i0.ɵɵrestoreView(_r6); const ctx_r1 = i0.ɵɵnextContext(3); return i0.ɵɵresetView(ctx_r1.dropTarget.set(undefined)); })("drop", function MyFilesTree_For_8_Conditional_11_For_4_Template_a_drop_3_listener($event) { const node_r8 = i0.ɵɵrestoreView(_r6).$implicit; const group_r4 = i0.ɵɵnextContext(2).$implicit; const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.dropFolder($event, node_r8.file.id, group_r4.id)); });
    ...
    i0.ɵɵtext(8);
    i0.ɵɵelementEnd()();
    i0.ɵɵconditionalCreate(9, MyFilesTree_For_8_Conditional_11_For_4_Conditional_9_Template, 3, 5, "button", 22);
    i0.ɵɵtemplate(10, MyFilesTree_For_8_Conditional_11_For_4_ng_template_10_Template, 12, 15, "ng-template", null, 1, i0.ɵɵtemplateRefExtractor);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵclassProp("my-files-drop-target", ctx_r1.dropTarget() === node_r8.file.id && group_r4.id !== "trash");
...
function MyFilesTree_For_8_Conditional_11_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "ul", 13);
    i0.ɵɵpipe(1, "t");
    i0.ɵɵpipe(2, "t");
    i0.ɵɵrepeaterCreate(3, MyFilesTree_For_8_Conditional_11_For_4_Template, 12, 20, "li", 15, _forTrack3);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function MyFilesTree_For_8_Template(rf, ctx) { if (rf & 1) {
    const _r3 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "li", 6)(1, "div", 9);
    i0.ɵɵanimateEnter("sidebar-item-enter");
    i0.ɵɵelementStart(2, "a", 10);
    i0.ɵɵlistener("click", function MyFilesTree_For_8_Template_a_click_2_listener() { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.closeMobile()); })("contextmenu", function MyFilesTree_For_8_Template_a_contextmenu_2_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.rememberContextTrigger($event)); })("keydown", function MyFilesTree_For_8_Template_a_keydown_2_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.rememberContextTriggerKey($event)); })("dragover", function MyFilesTree_For_8_Template_a_dragover_2_listener($event) { const group_r4 = i0.ɵɵrestoreView(_r3).$implicit; const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.dragOver($event, null, group_r4.id)); })("dragleave", function MyFilesTree_For_8_Template_a_dragleave_2_listener() { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.dropTarget.set(undefined)); })("drop", function MyFilesTree_For_8_Template_a_drop_2_listener($event) { const group_r4 = i0.ɵɵrestoreView(_r3).$implicit; const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.dropFolder($event, null, group_r4.id)); });
    ...
    i0.ɵɵtext(8);
    i0.ɵɵelementEnd()();
    i0.ɵɵtemplate(9, MyFilesTree_For_8_ng_template_9_Template, 4, 4, "ng-template", null, 0, i0.ɵɵtemplateRefExtractor);
    i0.ɵɵelementEnd();
    i0.ɵɵconditionalCreate(11, MyFilesTree_For_8_Conditional_11_Template, 5, 5, "ul", 13);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const group_r4 = ctx.$implicit;
    const ɵ$index_15_r13 = ctx.$index;
    const myFilesGroupMenu_r14 = i0.ɵɵreference(10);
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance();
    i0.ɵɵstyleProp("--%NS%sidebar-item-index", ɵ$index_15_r13);
    i0.ɵɵadvance();
    i0.ɵɵclassProp("my-files-drop-target", group_r4.id === "my-files" && ctx_r1.dropTarget() === null);
    i0.ɵɵproperty("hlmContextMenuTrigger", group_r4.id === "my-files" ? myFilesGroupMenu_r14 : null)("disabled", ctx_r1.busy())("queryParams", i0.ɵɵpureFunction1(15, _c0, group_r4.id))("isActive", ctx_r1.selectedGroup() === group_r4.id && !ctx_r1.selectedFolder());
...
export const myFileIcons = provideIcons({
    lucideEllipsis,
    lucideFolder,
    lucideChevronRight,
    lucideChevronDown,
...
export const fileGroups = [
    { id: 'my-files', label: 'files', icon: 'lucideFolder' },
...
export class MyFileIcon {
    ...
    static ɵfac = function MyFileIcon_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || MyFileIcon)(); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: MyFileIcon, selectors: [["app-my-file-icon"]], hostAttrs: [1, "my-file-icon"], hostVars: 1, hostBindings: function MyFileIcon_HostBindings(rf, ctx) { if (rf & 2) {
            ...
            ])], decls: 1, vars: 1, consts: [["size", "100%", "aria-hidden", "true", 3, "name"]], template: function MyFileIcon_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelement(0, "ng-icon", 0);
        } if (rf & 2) {
            i0.ɵɵproperty("name", ctx.icon());
        } }, dependencies: [NgIcon], encapsulation: 2 });
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MyFileIcon, [{
        type: Component,
        args: [{
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(MyFileIcon, { className: "MyFileIcon", filePath: "src/app/features/my-files-components.ts", lineNumber: 140 }); })();
export class MyFileActions {
    actions = input.required(/* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "actions" }] : /* istanbul ignore next */ []));
    name = input.required(/* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "name" }] : /* istanbul ignore next */ []));
    static ɵfac = function MyFileActions_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || MyFileActions)(); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: MyFileActions, selectors: [["app-my-file-actions"]], inputs: { actions: [1, "actions"], name: [1, "name"] }, features: [i0.ɵɵProvidersFeature([workspaceIcons])], decls: 3, vars: 0, consts: [[1, "flex", "justify-end", "gap-1"], ["hlmBtn", "", "variant", "ghost", "size", "icon-sm", 3, "disabled"], ["hlmBtn", "", "variant", "ghost", "size", "icon-sm", 3, "click", "disabled"], ["aria-hidden", "true", 3, "name"]], template: function MyFileActions_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelementStart(0, "div", 0);
            i0.ɵɵrepeaterCreate(1, MyFileActions_For_2_Template, 4, 10, "button", 1, _forTrack0);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
            i0.ɵɵadvance();
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MyFileActions, [{
        type: Component,
        args: [{
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(MyFileActions, { className: "MyFileActions", filePath: "src/app/features/my-files-components.ts", lineNumber: 168 }); })();
export class MyFileName {
    file = input.required(/* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "file" }] : /* istanbul ignore next */ []));
    ...
    static ɵfac = function MyFileName_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || MyFileName)(); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: MyFileName, selectors: [["app-my-file-name"]], inputs: { file: [1, "file"], open: [1, "open"], interactive: [1, "interactive"], back: [1, "back"] }, features: [i0.ɵɵProvidersFeature([provideIcons({ lucideArrowLeft })])], decls: 10, vars: 5, consts: [[1, "flex", "items-center", "gap-3", "min-w-0"], ["name", "lucideArrowLeft", "aria-hidden", "true", 1, "my-file-icon"], [3, "file"], [1, "min-w-0"], ["hlmBtn", "", "variant", "link", 1, "max-w-full"], [1, "block", "truncate", "font-medium"], [1, "workspace-meta", "truncate"], ["hlmBadge", "", "variant", "outline"], ["hlmBtn", "", "variant", "link", 1, "max-w-full", 3, "click"], [1, "truncate"]], template: function MyFileName_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelementStart(0, "div", 0);
            i0.ɵɵconditionalCreate(1, MyFileName_Conditional_1_Template, 1, 0, "ng-icon", 1)(2, MyFileName_Conditional_2_Template, 1, 1, "app-my-file-icon", 2);
            i0.ɵɵelementStart(3, "div", 3);
            i0.ɵɵconditionalCreate(4, MyFileName_Conditional_4_Template, 3, 1, "button", 4)(5, MyFileName_Conditional_5_Template, 2, 1, "span", 5);
            i0.ɵɵelementStart(6, "p", 6);
            i0.ɵɵtext(7);
            i0.ɵɵelementEnd();
            i0.ɵɵconditionalCreate(8, MyFileName_Conditional_8_Template, 3, 3, "span", 7);
            i0.ɵɵconditionalCreate(9, MyFileName_Conditional_9_Template, 3, 3, "span", 7);
            i0.ɵɵelementEnd()();
        } if (rf & 2) {
            i0.ɵɵadvance();
        ...
        } }, dependencies: [i1.FormsModule, i2.NgIcon, i3.HlmButton, i5.HlmBadge, MyFileIcon, i4.Translate], encapsulation: 2 });
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MyFileName, [{
        type: Component,
        args: [{
                selector: 'app-my-file-name',
                imports: [WorkspaceUi, MyFileIcon],
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(MyFileName, { className: "MyFileName", filePath: "src/app/features/my-files-components.ts", lineNumber: 201 }); })();
export class MyFilesActionDialog {
    ...
    fieldId = input('my-files-action', /* @ts-ignore */
    ...
    static ɵfac = function MyFilesActionDialog_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || MyFilesActionDialog)(); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: MyFilesActionDialog, selectors: [["app-my-files-action-dialog"]], inputs: { mode: [1, "mode"], description: [1, "description"], destinations: [1, "destinations"], busy: [1, "busy"], fieldId: [1, "fieldId"] }, outputs: { cancelled: "cancelled", createFolder: "createFolder", move: "move" }, decls: 2, vars: 1, consts: [[3, "stateChanged", "state"], [4, "hlmAlertDialogPortal"], ["hlmAlertDialogTitle", ""], ["hlmAlertDialogDescription", ""], [1, "grid", "gap-4"], [1, "grid", "gap-4", 3, "ngSubmit"], ["hlmField", ""], ["hlmFieldLabel", "", 3, "for"], ["hlmInput", "", "name", "folderName", "required", "", "maxlength", "180", 3, "ngModelChange", "id", "ngModel", "disabled"], ["hlmAlertDialogCancel", "", "type", "button", 3, "disabled"], ["hlmAlertDialogAction", "", "type", "submit", 3, "disabled"], [3, "valueChange", "value", "itemToString"], [3, "id"], [4, "hlmSelectPortal"], ["hlmAlertDialogCancel", "", 3, "disabled"], ["hlmAlertDialogAction", "", 3, "click", "disabled"], [3, "value", "disabled"]], template: function MyFilesActionDialog_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelementStart(0, "hlm-alert-dialog", 0);
            i0.ɵɵlistener("stateChanged", function MyFilesActionDialog_Template_hlm_alert_dialog_stateChanged_0_listener($event) { return ctx.stateChanged($event); });
            i0.ɵɵtemplate(1, MyFilesActionDialog_hlm_alert_dialog_content_1_Template, 9, 5, "hlm-alert-dialog-content", 1);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MyFilesActionDialog, [{
        type: Component,
        args: [{
                selector: 'app-my-files-action-dialog',
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(MyFilesActionDialog, { className: "MyFilesActionDialog", filePath: "src/app/features/my-files-components.ts", lineNumber: 280 }); })();
export class MyFilesNavigation {
    revision = signal(0, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "revision" }] : /* istanbul ignore next */ []));
    refresh() {
        this.revision.update((x) => x + 1);
    }
    static ɵfac = function MyFilesNavigation_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || MyFilesNavigation)(); };
    static ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: MyFilesNavigation, factory: MyFilesNavigation.ɵfac, providedIn: 'root' });
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MyFilesNavigation, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], null, null); })();
export class MyFilesTree {
    ...
    selectedGroup = signal('my-files', /* @ts-ignore */
    ...
    startDrag(event, file, group) {
        ...
        if (event.dataTransfer) {
            ...
            event.dataTransfer.setData('application/x-my-files-folder', file.id);
        }
    }
    endDrag() {
    ...
    dragOver(event, parent, group) {
        ...
        if (this.busy() ||
            group === 'trash' ||
            (!parent && group !== 'my-files') ||
            !source ||
            !canMoveFolder(source, parent, this.folders('my-files')))
            return;
        event.preventDefault();
        if (event.dataTransfer)
    ...
    folderLocation(folder) {
        ...
        while (parent && !seen.has(parent)) {
            seen.add(parent);
            const entry = this.folders('my-files').find((item) => item.id === parent);
            if (!entry)
                break;
    ...
    async moveFolder(source, parentId) {
        if (this.busy() || !canMoveFolder(source, parentId, this.folders('my-files')))
            return;
        this.busy.set(true);
        try {
            await this.api.post(`my-files/${source.id}/move`, { parentId });
    ...
    syncRoute() {
        const params = this.router.url.startsWith('/my-files')
            ? this.router.parseUrl(this.router.url).queryParams
            : {};
        this.selectedGroup.set(params['group'] || 'my-files');
    ...
    async load() {
        ...
        await this.data.load(async (signal) => Object.fromEntries(await Promise.all(this.groups.map(async (group) => [
            group.id,
            await this.api.get('my-files', { group: group.id, pageSize: 1 }, signal),
        ]))));
    }
    ...
    async deleteFolder(folder) {
        ...
        this.busy.set(true);
        try {
            await this.api.post(`my-files/${folder.id}/delete`);
            if (this.selectedFolder() === folder.id)
                await this.router.navigate(['/my-files'], {
    ...
    static ɵfac = function MyFilesTree_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || MyFilesTree)(); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: MyFilesTree, selectors: [["app-my-files-tree"]], features: [i0.ɵɵProvidersFeature([myFileIcons])], decls: 10, vars: 11, consts: [["myFilesGroupMenu", ""], ["folderMenu", ""], ["hlmSidebarGroup", "", 1, "sidebar-submenu"], ["hlmSidebarGroupLabel", ""], ["hlmBtn", "", "variant", "ghost"], ["hlmSidebarMenu", ""], ["hlmSidebarMenuItem", ""], ["fieldId", "submenu-folder-action", 3, "cancelled", "createFolder", "move", "mode", "description", "destinations", "busy"], ["hlmBtn", "", "variant", "ghost", 3, "click"], [1, "flex", "items-center", "min-w-0"], ["hlmSidebarMenuButton", "", "routerLink", "/my-files", 3, "click", "contextmenu", "keydown", "dragover", "dragleave", "drop", "hlmContextMenuTrigger", "disabled", "queryParams", "isActive"], [3, "name"], [1, "my-files-nav-count"], [1, "my-files-tree"], ["hlmDropdownMenuItem", "", 3, "triggered", "disabled"], [1, "flex", "items-center", "min-w-0", 3, "--%NS%sidebar-item-index", "padding-inline-start", "hlmContextMenuTrigger", "disabled"], [1, "flex", "items-center", "min-w-0", 3, "contextmenu", "keydown", "hlmContextMenuTrigger", "disabled"], ["hlmBtn", "", "variant", "ghost", "size", "icon-sm"], ["aria-hidden", "true", 1, "size-8", "shrink-0"], ["hlmSidebarMenuButton", "", "routerLink", "/my-files", 3, "click", "dragstart", "dragend", "dragover", "dragleave", "drop", "queryParams", "isActive", "draggable"], [3, "file"], [1, "truncate"], ["hlmBtn", "", "variant", "ghost", "size", "icon-sm", 3, "disabled", "hlmDropdownMenuTrigger"], ["hlmBtn", "", "variant", "ghost", "size", "icon-sm", 3, "click"], ["hlmBtn", "", "variant", "ghost", "size", "icon-sm", 3, "click", "disabled", "hlmDropdownMenuTrigger"], ["name", "lucideEllipsis", "aria-hidden", "true"], ["hlmDropdownMenuItem", "", "variant", "destructive", 3, "triggered", "disabled"]], template: function MyFilesTree_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵpipe(4, "t");
            i0.ɵɵelementEnd();
            i0.ɵɵconditionalCreate(5, MyFilesTree_Conditional_5_Template, 3, 3, "button", 4);
            i0.ɵɵelementStart(6, "ul", 5);
            i0.ɵɵrepeaterCreate(7, MyFilesTree_For_8_Template, 12, 17, "li", 6, _forTrack2);
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(9, "app-my-files-action-dialog", 7);
            i0.ɵɵlistener("cancelled", function MyFilesTree_Template_app_my_files_action_dialog_cancelled_9_listener() { return ctx.closeContext(); })("createFolder", function MyFilesTree_Template_app_my_files_action_dialog_createFolder_9_listener($event) { return ctx.createFolder($event); })("move", function MyFilesTree_Template_app_my_files_action_dialog_move_9_listener($event) { return ctx.moveFromContext($event); });
            i0.ɵɵelementEnd();
        } if (rf & 2) {
        ...
        } }, dependencies: [i1.FormsModule, i10.RouterLink, i2.NgIcon, i3.HlmButton, i11.HlmSidebarGroup, i11.HlmSidebarGroupLabel, i11.HlmSidebarMenu, i11.HlmSidebarMenuButton, i11.HlmSidebarMenuItem, MyFileIcon, MyFilesActionDialog, i12.HlmContextMenuTrigger, i13.HlmDropdownMenu, i13.HlmDropdownMenuItem, i13.HlmDropdownMenuSeparator, i13.HlmDropdownMenuTrigger, i4.Translate], encapsulation: 2 });
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MyFilesTree, [{
        type: Component,
        args: [{
                selector: 'app-my-files-tree',
                imports: [
                    WorkspaceUi,
                    HlmSidebarImports,
                    MyFileIcon,
          ...
          <li hlmSidebarMenuItem>
            ...
            >
              <a
                ...
                [hlmContextMenuTrigger]="group.id === 'my-files' ? myFilesGroupMenu : null"
                [disabled]="busy()"
                routerLink="/my-files"
                (click)="closeMobile()"
                ...
                [class.my-files-drop-target]="group.id === 'my-files' && dropTarget() === null"
                ...
                ><span class="my-files-nav-count">{{ count(group.id) }}</span></a
              >
              <ng-template #myFilesGroupMenu>
                <hlm-dropdown-menu>
                  <button
                    hlmDropdownMenuItem
                    [disabled]="busy()"
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(MyFilesTree, { className: "MyFilesTree", filePath: "src/app/features/my-files-components.ts", lineNumber: 510 }); })();
