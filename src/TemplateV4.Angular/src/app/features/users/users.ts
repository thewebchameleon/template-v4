...
import { AccountSecurityPanel } from '../mfa/account-security';
import { RegistrationRequestsPage } from '../identity/registration/registration-requests';
import { PrivacyRequestsPage } from '../privacy/privacy-requests';
