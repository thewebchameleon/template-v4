...
function DataTable_For_6_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r2 = i0.ɵɵnextContext();
    i0.ɵɵclassProp("cursor-pointer", !!ctx_r2.rowActionLabel())("opacity-50", ctx_r2.rowDragging()?.(row_r8.original))("my-files-drop-target", ctx_r2.rowDropActive()?.(row_r8.original));
