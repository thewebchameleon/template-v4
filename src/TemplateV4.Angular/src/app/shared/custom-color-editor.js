...
function CustomColorEditor_hlm_drawer_content_3_Conditional_17_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "hlm-field-error", 13);
    i0.ɵɵtext(1);
    i0.ɵɵpipe(2, "t");
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function CustomColorEditor_hlm_drawer_content_3_For_21_Template(rf, ctx) { if (rf & 1) {
    const _r4 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "div", 16)(1, "div", 21)(2, "span");
    i0.ɵɵtext(3);
    i0.ɵɵpipe(4, "t");
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵtext(6);
    i0.ɵɵelementEnd()();
    i0.ɵɵelementStart(7, "hlm-slider", 23);
    i0.ɵɵlistener("valueChange", function CustomColorEditor_hlm_drawer_content_3_For_21_Template_hlm_slider_valueChange_7_listener($event) { const axis_r5 = i0.ɵɵrestoreView(_r4).$implicit; const ctx_r1 = i0.ɵɵnextContext(2); return i0.ɵɵresetView(ctx_r1.setAxis(axis_r5.key, $event)); });
    i0.ɵɵelementEnd()();
} if (rf & 2) {
...
function CustomColorEditor_hlm_drawer_content_3_Conditional_32_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "hlm-field-error", 13);
    i0.ɵɵtext(1);
    i0.ɵɵpipe(2, "t");
    i0.ɵɵelementEnd();
...
function CustomColorEditor_hlm_drawer_content_3_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵlistener("pointerdown", function CustomColorEditor_hlm_drawer_content_3_Template_div_pointerdown_8_listener($event) { return $event.stopPropagation(); });
    i0.ɵɵelementStart(9, "div", 9)(10, "label", 10);
    i0.ɵɵtext(11);
    i0.ɵɵpipe(12, "t");
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(13, "input", 11);
    i0.ɵɵlistener("ngModelChange", function CustomColorEditor_hlm_drawer_content_3_Template_input_ngModelChange_13_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.name.set($event)); });
    i0.ɵɵelementEnd();
    i0.ɵɵcontrolCreate();
    ...
    i0.ɵɵpipe(16, "t");
    i0.ɵɵelementEnd();
    i0.ɵɵconditionalCreate(17, CustomColorEditor_hlm_drawer_content_3_Conditional_17_Template, 3, 3, "hlm-field-error", 13);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(18, "div", 14);
    i0.ɵɵlistener("pointerdown", function CustomColorEditor_hlm_drawer_content_3_Template_div_pointerdown_18_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.startDrag($event)); })("pointermove", function CustomColorEditor_hlm_drawer_content_3_Template_div_pointermove_18_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.drag($event)); })("pointerup", function CustomColorEditor_hlm_drawer_content_3_Template_div_pointerup_18_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.endDrag($event)); })("pointercancel", function CustomColorEditor_hlm_drawer_content_3_Template_div_pointercancel_18_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.endDrag($event)); });
    i0.ɵɵelement(19, "span", 15);
    i0.ɵɵelementEnd();
    i0.ɵɵrepeaterCreate(20, CustomColorEditor_hlm_drawer_content_3_For_21_Template, 8, 13, "div", 16, _forTrack0);
    ...
    i0.ɵɵlistener("ngModelChange", function CustomColorEditor_hlm_drawer_content_3_Template_input_ngModelChange_28_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.setHex($event)); });
    i0.ɵɵelementEnd();
    i0.ɵɵcontrolCreate();
    i0.ɵɵelementEnd();
    ...
    i0.ɵɵpipe(31, "t");
    i0.ɵɵelementEnd();
    i0.ɵɵconditionalCreate(32, CustomColorEditor_hlm_drawer_content_3_Conditional_32_Template, 3, 3, "hlm-field-error", 13);
    i0.ɵɵelementEnd()();
    i0.ɵɵelementStart(33, "hlm-drawer-footer")(34, "button", 20);
    i0.ɵɵlistener("click", function CustomColorEditor_hlm_drawer_content_3_Template_button_click_34_listener() { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1.apply()); });
    i0.ɵɵtext(35);
    i0.ɵɵpipe(36, "t");
    i0.ɵɵelementEnd()()();
} if (rf & 2) {
    ...
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind1(12, 36, "customColorName"));
    i0.ɵɵadvance(2);
    ...
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind1(16, 38, "customColorNameHelp"));
    i0.ɵɵadvance(2);
    i0.ɵɵconditional(ctx_r1.name() && !ctx_r1.validName() ? 17 : -1);
    i0.ɵɵadvance();
    ...
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind1(25, 40, "customHexColor"));
    i0.ɵɵadvance(3);
    ...
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate(i0.ɵɵpipeBind1(31, 42, "primaryColorHelp"));
    i0.ɵɵadvance(2);
    i0.ɵɵconditional(!ctx_r1.validHex() ? 32 : -1);
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("disabled", !ctx_r1.validHex() || !ctx_r1.validName() || ctx_r1.disabled());
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate1(" ", i0.ɵɵpipeBind1(36, 44, "useCustomColor"), " ");
} }
export class CustomColorEditor {
    ...
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: CustomColorEditor, selectors: [["app-custom-color-editor"]], inputs: { item: [1, "item"], initialColor: [1, "initialColor"], usedNames: [1, "usedNames"], disabled: [1, "disabled"] }, outputs: { changed: "changed", preview: "preview" }, decls: 4, vars: 2, consts: [["direction", "right", 3, "stateChanged", "state"], ["hlmBtn", "", "variant", "outline", "size", "icon-sm", "type", "button", "hlmDrawerTrigger", "", 3, "disabled", "title"], ["hlmBtn", "", "variant", "outline", "type", "button", "hlmDrawerTrigger", "", 3, "disabled"], ["class", "overflow-hidden sm:max-w-md", 4, "hlmDrawerPortal"], ["name", "lucidePencil", "aria-hidden", "true"], [1, "overflow-hidden", "sm:max-w-md"], ["hlmDrawerTitle", ""], ["hlmDrawerDescription", ""], ["hlmDrawerBody", "", 1, "flex", "min-h-0", "flex-1", "flex-col", "gap-6", "overflow-y-auto", "pb-1", 3, "pointerdown"], ["hlmField", ""], ["hlmFieldLabel", "", 3, "for"], ["hlmInput", "", "maxlength", "40", "autocomplete", "off", 3, "ngModelChange", "id", "ngModel", "ngModelOptions"], ["hlmFieldDescription", "", 3, "id"], ["forceShow", ""], ["aria-hidden", "true", 1, "color-plane", 3, "pointerdown", "pointermove", "pointerup", "pointercancel"], [1, "color-point"], [1, "grid", "gap-2", "rounded-lg", "border", "border-border/70", "bg-muted/30", "px-3", "py-3"], [1, "flex", "items-center", "gap-2"], ["aria-hidden", "true", 1, "size-8", "shrink-0", "rounded-md", "border", "border-border"], ["hlmInput", "", "maxlength", "7", "spellcheck", "false", "autocomplete", "off", 3, "ngModelChange", "id", "ngModel", "ngModelOptions"], ["hlmBtn", "", "type", "button", 3, "click", "disabled"], [1, "flex", "items-center", "justify-between", "gap-3", "text-sm", "font-medium", "leading-none", 3, "id"], ["aria-hidden", "true", 1, "text-muted-foreground", "tabular-nums"], [1, "py-1.5", 3, "valueChange", "value", "min", "max", "step", "aria-labelledby"]], template: function CustomColorEditor_Template(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵtemplate(3, CustomColorEditor_hlm_drawer_content_3_Template, 37, 48, "hlm-drawer-content", 3);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
            let tmp_1_0;
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(CustomColorEditor, { className: "CustomColorEditor", filePath: "src/app/shared/custom-color-editor.ts", lineNumber: 160 }); })();
