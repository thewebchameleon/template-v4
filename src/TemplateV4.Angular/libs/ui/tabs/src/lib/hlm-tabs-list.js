...
export const listVariants = cva('relative rounded-lg p-[3px] group-data-horizontal/tabs:h-9 data-[variant=line]:rounded-none group/tabs-list text-muted-foreground inline-flex w-fit items-center justify-center group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col', {
    variants: {
        variant: {
            default: 'bg-muted',
...
export class HlmTabsList {
    ...
    constructor() {
        ...
        const positionIndicator = (target) => {
            if (this.variant() !== 'default') {
                indicator.style.opacity = '0';
                return;
            }
            const selected = target ??
                element.querySelector('[data-slot="tabs-trigger"][aria-selected="true"]');
            if (!selected) {
                indicator.style.opacity = '0';
                return;
            }
    ...
    static ɵfac = function HlmTabsList_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || HlmTabsList)(); };
    static ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: HlmTabsList, selectors: [["", "hlmTabsList", ""], ["hlm-tabs-list"]], hostAttrs: ["data-slot", "tabs-list"], hostVars: 1, hostBindings: function HlmTabsList_HostBindings(rf, ctx) { if (rf & 2) {
            i0.ɵɵattribute("data-variant", ctx.variant());
        } }, inputs: { variant: [1, "variant"] }, features: [i0.ɵɵHostDirectivesFeature([i1.BrnTabsList])] });
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(HlmTabsList, [{
        type: Directive,
        args: [{
