...
export class HlmDrawerContent {
    ...
    constructor() {
        classes(() => [
            ...
            'data-[vaul-drawer-direction=right]:[--drawer-body-padding-block-start:var(--panel-header-padding-inline)] data-[vaul-drawer-direction=right]:[--drawer-body-padding-block-end:var(--card-spacing)] data-[vaul-drawer-direction=right]:[--drawer-body-padding-inline:var(--panel-header-padding-inline)]',
