...
export class HlmDrawerContent {
  ...
  constructor() {
    classes(() => [
      'bg-background fixed z-50 flex h-auto flex-col border text-sm md:shadow-sm data-[vaul-drawer-direction=bottom]:inset-x-0 data-[vaul-drawer-direction=bottom]:bottom-0 data-[vaul-drawer-direction=bottom]:mt-24 data-[vaul-drawer-direction=bottom]:max-h-[80vh] data-[vaul-drawer-direction=bottom]:rounded-t-xl md:data-[vaul-drawer-direction=bottom]:inset-x-2 md:data-[vaul-drawer-direction=bottom]:bottom-2 md:data-[vaul-drawer-direction=bottom]:rounded-xl data-[vaul-drawer-direction=left]:inset-y-0 data-[vaul-drawer-direction=left]:left-0 data-[vaul-drawer-direction=left]:w-3/4 data-[vaul-drawer-direction=left]:rounded-r-xl md:data-[vaul-drawer-direction=left]:inset-y-2 md:data-[vaul-drawer-direction=left]:left-2 md:data-[vaul-drawer-direction=left]:rounded-xl data-[vaul-drawer-direction=right]:inset-y-0 data-[vaul-drawer-direction=right]:right-0 data-[vaul-drawer-direction=right]:w-3/4 data-[vaul-drawer-direction=right]:rounded-l-xl md:data-[vaul-drawer-direction=right]:inset-y-2 md:data-[vaul-drawer-direction=right]:right-2 md:data-[vaul-drawer-direction=right]:rounded-xl data-[vaul-drawer-direction=top]:inset-x-0 data-[vaul-drawer-direction=top]:top-0 data-[vaul-drawer-direction=top]:mb-24 data-[vaul-drawer-direction=top]:max-h-[80vh] data-[vaul-drawer-direction=top]:rounded-b-xl md:data-[vaul-drawer-direction=top]:inset-x-2 md:data-[vaul-drawer-direction=top]:top-2 md:data-[vaul-drawer-direction=top]:rounded-xl data-[vaul-drawer-direction=left]:sm:max-w-sm data-[vaul-drawer-direction=right]:sm:max-w-sm',
