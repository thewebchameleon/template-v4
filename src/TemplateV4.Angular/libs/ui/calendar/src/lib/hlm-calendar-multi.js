...
function HlmCalendarMulti_ng_template_2_hlm_select_content_3_For_3_Template(rf, ctx) { if (rf & 1) {
...
function HlmCalendarMulti_ng_template_2_hlm_select_content_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "hlm-select-content", 18)(1, "hlm-select-group");
    i0.ɵɵrepeaterCreate(2, HlmCalendarMulti_ng_template_2_hlm_select_content_3_For_3_Template, 2, 2, "hlm-select-item", 19, i0.ɵɵrepeaterTrackByIdentity);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
...
function HlmCalendarMulti_ng_template_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "hlm-select", 15)(1, "hlm-select-trigger", 16);
    i0.ɵɵelement(2, "hlm-select-value");
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(3, HlmCalendarMulti_ng_template_2_hlm_select_content_3_Template, 4, 0, "hlm-select-content", 17);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function HlmCalendarMulti_ng_template_4_hlm_select_content_3_For_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "hlm-select-item", 19);
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
function HlmCalendarMulti_ng_template_4_hlm_select_content_3_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "hlm-select-content", 18)(1, "hlm-select-group");
    i0.ɵɵrepeaterCreate(2, HlmCalendarMulti_ng_template_4_hlm_select_content_3_For_3_Template, 2, 2, "hlm-select-item", 19, i0.ɵɵrepeaterTrackByIdentity);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext(2);
    i0.ɵɵadvance(2);
...
function HlmCalendarMulti_ng_template_4_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "hlm-select", 20)(1, "hlm-select-trigger", 16);
    i0.ɵɵelement(2, "hlm-select-value");
    i0.ɵɵelementEnd();
    i0.ɵɵtemplate(3, HlmCalendarMulti_ng_template_4_hlm_select_content_3_Template, 4, 0, "hlm-select-content", 17);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance();
...
function HlmCalendarMulti_Case_9_Template(rf, ctx) { if (rf & 1) {
...
function HlmCalendarMulti_Case_10_Template(rf, ctx) { if (rf & 1) {
...
function HlmCalendarMulti_Case_11_Template(rf, ctx) { if (rf & 1) {
...
function HlmCalendarMulti_Case_12_Template(rf, ctx) { if (rf & 1) {
...
function HlmCalendarMulti_th_18_Template(rf, ctx) { if (rf & 1) {
...
function HlmCalendarMulti_tr_20_For_2_Template(rf, ctx) { if (rf & 1) {
...
function HlmCalendarMulti_tr_20_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "tr", 25);
    i0.ɵɵrepeaterCreate(1, HlmCalendarMulti_tr_20_For_2_Template, 3, 4, "td", 26, _forTrack0, true);
    i0.ɵɵelementEnd();
} if (rf & 2) {
...
export class HlmCalendarMulti {
    ...
    static ɵfac = function HlmCalendarMulti_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || HlmCalendarMulti)(); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: HlmCalendarMulti, selectors: [["hlm-calendar-multi"]], hostAttrs: ["data-slot", "calendar"], inputs: { captionLayout: [1, "captionLayout"] }, features: [i0.ɵɵProvidersFeature([], [provideIcons({ lucideChevronLeft, lucideChevronRight })]), i0.ɵɵHostDirectivesFeature([{ directive: i1.BrnCalendarMulti, inputs: ["min", "min", "max", "max", "minSelection", "minSelection", "maxSelection", "maxSelection", "disabled", "disabled", "date", "date", "dateDisabled", "dateDisabled", "weekStartsOn", "weekStartsOn", "highlightDays", "highlightDays", "defaultFocusedDate", "defaultFocusedDate"], outputs: ["dateChange", "dateChange"] }])], decls: 21, vars: 2, consts: [["month", ""], ["year", ""], [1, "inline-flex", "flex-col", "space-y-4"], [1, "flex", "w-full", "items-center", "justify-between", "gap-1.5"], ["brnCalendarPreviousButton", "", "variant", "ghost", "hlmBtn", "", 1, "order-first", "size-(--cell-size)", "p-0", "select-none", "aria-disabled:opacity-50"], ["name", "lucideChevronLeft", 1, "rtl:rotate-180"], ["brnCalendarHeader", "", 1, "order-5", "text-sm", "font-medium"], ["brnCalendarNextButton", "", "hlmBtn", "", "variant", "ghost", 1, "order-last", "size-(--cell-size)", "p-0", "select-none", "aria-disabled:opacity-50"], ["name", "lucideChevronRight", 1, "rtl:rotate-180"], ["brnCalendarGrid", "", 1, "w-full", "border-collapse"], ["aria-hidden", "true"], [1, "flex"], ["scope", "col", "class", "text-muted-foreground flex-1 rounded-(--cell-radius) text-[0.8rem] font-normal select-none", 4, "brnCalendarWeekday"], ["role", "rowgroup"], ["class", "mt-2 flex w-full", 4, "brnCalendarWeek"], ["brnCalendarMonthSelect", "", 1, "order-1"], ["size", "sm"], ["class", "max-h-80", 4, "hlmSelectPortal"], [1, "max-h-80"], [3, "value"], ["brnCalendarYearSelect", "", 1, "order-3"], [3, "ngTemplateOutlet"], ["brnCalendarHeader", "", 1, "order-4", "text-sm", "font-medium"], ["brnCalendarHeader", "", 1, "order-2", "text-sm", "font-medium"], ["scope", "col", 1, "text-muted-foreground", "flex-1", "rounded-(--cell-radius)", "text-[0.8rem]", "font-normal", "select-none"], [1, "mt-2", "flex", "w-full"], ["brnCalendarCell", "", 1, "group/day", "relative", "aspect-square", "h-full", "w-full", "rounded-(--cell-radius)", "p-0", "text-center", "select-none", "[&:first-child[data-selected=true]_button]:rounded-s-(--cell-radius)", "[&:last-child[data-selected=true]_button]:rounded-e-(--cell-radius)"], ["brnCalendarCellButton", "", 3, "date"]], template: function HlmCalendarMulti_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelementStart(0, "div", 2)(1, "div", 3);
            i0.ɵɵtemplate(2, HlmCalendarMulti_ng_template_2_Template, 4, 2, "ng-template", null, 0, i0.ɵɵtemplateRefExtractor)(4, HlmCalendarMulti_ng_template_4_Template, 4, 2, "ng-template", null, 1, i0.ɵɵtemplateRefExtractor);
            i0.ɵɵdeclareLet(6);
            i0.ɵɵelementStart(7, "button", 4);
            i0.ɵɵelement(8, "ng-icon", 5);
            i0.ɵɵelementEnd();
            i0.ɵɵconditionalCreate(9, HlmCalendarMulti_Case_9_Template, 2, 2)(10, HlmCalendarMulti_Case_10_Template, 3, 2)(11, HlmCalendarMulti_Case_11_Template, 3, 2)(12, HlmCalendarMulti_Case_12_Template, 2, 1, "div", 6);
            i0.ɵɵelementStart(13, "button", 7);
            i0.ɵɵelement(14, "ng-icon", 8);
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(15, "table", 9)(16, "thead", 10)(17, "tr", 11);
            i0.ɵɵtemplate(18, HlmCalendarMulti_th_18_Template, 2, 2, "th", 12);
            i0.ɵɵelementEnd()();
            i0.ɵɵelementStart(19, "tbody", 13);
            i0.ɵɵtemplate(20, HlmCalendarMulti_tr_20_Template, 3, 0, "tr", 14);
            i0.ɵɵelementEnd()()();
        } if (rf & 2) {
            let tmp_3_0;
            i0.ɵɵadvance(6);
        ...
        } }, dependencies: [i1.BrnCalendarCellButton, i1.BrnCalendarGrid, i1.BrnCalendarHeader, i1.BrnCalendarNextButton, i1.BrnCalendarPreviousButton, i1.BrnCalendarWeek, i1.BrnCalendarWeekday, i1.BrnCalendarCell, i1.BrnCalendarMonthSelect, i1.BrnCalendarYearSelect, NgIcon, NgTemplateOutlet, i2.HlmSelect, i2.HlmSelectContent, i2.HlmSelectGroup, i2.HlmSelectItem, i2.HlmSelectPortal, i2.HlmSelectTrigger, i2.HlmSelectValue, i3.HlmButton], encapsulation: 2 });
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(HlmCalendarMulti, [{
        type: Component,
        args: [{
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(HlmCalendarMulti, { className: "HlmCalendarMulti", filePath: "libs/ui/calendar/src/lib/hlm-calendar-multi.ts", lineNumber: 142 }); })();
