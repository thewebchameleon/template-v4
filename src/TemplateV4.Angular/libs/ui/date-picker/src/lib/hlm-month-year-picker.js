...
import * as i3 from "@spartan-ng/helm/calendar";
const _c0 = ["*", [["", "hlmDatePickerHeader", ""]], [["", "hlmDatePickerFooter", ""]]];
const _c1 = ["*", "[hlmDatePickerHeader]", "[hlmDatePickerFooter]"];
function HlmMonthYearPicker_hlm_popover_content_2_Template(rf, ctx) { if (rf & 1) {
    const _r1 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "hlm-popover-content", 2);
    i0.ɵɵprojection(1, 1);
    i0.ɵɵelementStart(2, "hlm-month-year-calendar", 3);
    i0.ɵɵlistener("dateChange", function HlmMonthYearPicker_hlm_popover_content_2_Template_hlm_month_year_calendar_dateChange_2_listener($event) { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1._handleChange($event)); });
    i0.ɵɵelementEnd();
    i0.ɵɵprojection(3, 2);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    ...
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("date", ctx_r1._mutableDate())("defaultFocusedDate", ctx_r1._mutableDate() ?? ctx_r1.defaultFocusedDate())("min", ctx_r1.minDate())("max", ctx_r1.maxDate())("disabled", ctx_r1._disabled());
} }
...
export class HlmMonthYearPicker {
    ...
    static ɵfac = function HlmMonthYearPicker_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || HlmMonthYearPicker)(); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: HlmMonthYearPicker, selectors: [["hlm-month-year-picker"]], contentQueries: function HlmMonthYearPicker_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
            i0.ɵɵcontentQuerySignal(dirIndex, ctx._trigger, BrnDatePickerTriggerToken, 5);
        } if (rf & 2) {
            i0.ɵɵqueryAdvance();
        } }, viewQuery: function HlmMonthYearPicker_Query(rf, ctx) { if (rf & 1) {
            i0.ɵɵviewQuerySignal(ctx.popover, BrnPopover, 5);
        } if (rf & 2) {
            i0.ɵɵqueryAdvance();
        } }, hostAttrs: [1, "block"], inputs: { align: [1, "align"], minDate: [1, "minDate"], maxDate: [1, "maxDate"], disabled: [1, "disabled"], date: [1, "date"], defaultFocusedDate: [1, "defaultFocusedDate"], autoCloseOnSelect: [1, "autoCloseOnSelect"], formatDate: [1, "formatDate"], transformDate: [1, "transformDate"] }, outputs: { dateChange: "dateChange" }, features: [i0.ɵɵProvidersFeature([
                HLM_MONTH_YEAR_PICKER_VALUE_ACCESSOR,
                provideBrnDatePicker(HlmMonthYearPicker),
                provideBrnLabelable(HlmMonthYearPicker),
            ]), i0.ɵɵHostDirectivesFeature([i1.BrnFieldControl])], ngContentSelectors: _c1, decls: 3, vars: 2, consts: [["sideOffset", "5", 3, "stateChanged", "align", "state"], ["class", "w-fit p-0", 4, "hlmPopoverPortal"], [1, "w-fit", "p-0"], [1, "rounded-none", "border-0", 3, "dateChange", "date", "defaultFocusedDate", "min", "max", "disabled"]], template: function HlmMonthYearPicker_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵprojectionDef(_c0);
            i0.ɵɵelementStart(0, "hlm-popover", 0);
            i0.ɵɵlistener("stateChanged", function HlmMonthYearPicker_Template_hlm_popover_stateChanged_0_listener($event) { return ctx._onStateChange($event); });
            i0.ɵɵprojection(1);
            i0.ɵɵtemplate(2, HlmMonthYearPicker_hlm_popover_content_2_Template, 4, 5, "hlm-popover-content", 1);
            i0.ɵɵelementEnd();
        } if (rf & 2) {
            i0.ɵɵproperty("align", ctx.align())("state", ctx._popoverState());
        } }, dependencies: [i2.HlmPopover, i2.HlmPopoverContent, i2.HlmPopoverPortal, i3.HlmMonthYearCalendar], encapsulation: 2 });
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(HlmMonthYearPicker, [{
        type: Component,
        args: [{
