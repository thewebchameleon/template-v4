...
function HlmDatePickerInput_Conditional_3_Template(rf, ctx) { if (rf & 1) {
    const _r1 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 6);
    i0.ɵɵlistener("click", function HlmDatePickerInput_Conditional_3_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r1); const ctx_r1 = i0.ɵɵnextContext(); return i0.ɵɵresetView(ctx_r1._clear()); });
...
export class HlmDatePickerInput extends BrnDateInput {
    ...
    static ɵfac = /*@__PURE__*/ (() => { let ɵHlmDatePickerInput_BaseFactory; return function HlmDatePickerInput_Factory(__ngFactoryType__) { return (ɵHlmDatePickerInput_BaseFactory || (ɵHlmDatePickerInput_BaseFactory = i0.ɵɵgetInheritedFactory(HlmDatePickerInput)))(__ngFactoryType__ || HlmDatePickerInput); }; })();
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: HlmDatePickerInput, selectors: [["hlm-date-picker-input"]], inputs: { parseDate: [1, "parseDate"], formatInputDate: [1, "formatInputDate"] }, features: [i0.ɵɵProvidersFeature([
                provideIcons({ lucideCalendar, lucideX }),
                provideBrnDatePickerTrigger(HlmDatePickerInput),
            ]), i0.ɵɵHostDirectivesFeature([i1.HlmInputGroup]), i0.ɵɵInheritDefinitionFeature], decls: 6, vars: 13, consts: [["input", ""], ["hlmInputGroupInput", "", 3, "click", "keydown.arrowDown", "keydown.enter", "input", "focus", "blur", "value", "id", "placeholder", "disabled", "forceInvalid"], ["align", "inline-end"], ["hlmInputGroupButton", "", "size", "icon-xs", "variant", "ghost", 3, "disabled"], ["hlmInputGroupButton", "", "size", "icon-xs", 3, "click", "disabled"], ["name", "lucideCalendar"], ["hlmInputGroupButton", "", "size", "icon-xs", "variant", "ghost", 3, "click", "disabled"], ["name", "lucideX"]], template: function HlmDatePickerInput_Template(rf, ctx) { if (rf & 1) {
            i0.ɵɵelementStart(0, "input", 1, 0);
            i0.ɵɵlistener("click", function HlmDatePickerInput_Template_input_click_0_listener() { return ctx._handleClick(); })("keydown.arrowDown", function HlmDatePickerInput_Template_input_keydown_arrowDown_0_listener() { return ctx._open(); })("keydown.enter", function HlmDatePickerInput_Template_input_keydown_enter_0_listener($event) { return ctx._handleEnter($event); })("input", function HlmDatePickerInput_Template_input_input_0_listener($event) { return ctx._handleInputChange($event); })("focus", function HlmDatePickerInput_Template_input_focus_0_listener() { return ctx._handleFocus(); })("blur", function HlmDatePickerInput_Template_input_blur_0_listener() { return ctx._handleBlur(); });
            i0.ɵɵelementEnd();
            i0.ɵɵelementStart(2, "hlm-input-group-addon", 2);
            i0.ɵɵconditionalCreate(3, HlmDatePickerInput_Conditional_3_Template, 2, 2, "button", 3);
            i0.ɵɵelementStart(4, "button", 4);
            i0.ɵɵlistener("click", function HlmDatePickerInput_Template_button_click_4_listener() { return ctx._popover().open(); });
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(HlmDatePickerInput, [{
        type: Component,
        args: [{
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(HlmDatePickerInput, { className: "HlmDatePickerInput", filePath: "libs/ui/date-picker/src/lib/hlm-date-picker-input.ts", lineNumber: 68 }); })();
