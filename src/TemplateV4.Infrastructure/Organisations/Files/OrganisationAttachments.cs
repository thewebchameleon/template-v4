...
public sealed class OrganisationAttachments(FrameworkDb db, IOrganisationOperations access, OrganisationFiles library) : IOrganisationAttachments
{
    ...
    {
        if (!await access.Allowed(actor, OrganisationOperation.Read, ct))
