...
namespace TemplateV4.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260914134631_ActionItemsAndRegistrationApproval")]
    partial class ActionItemsAndRegistrationApproval
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TemplateV4.Infrastructure.Persistence.ActionItemRow", b =>
                {
                    ...
                    b.Property<bool>("AdministratorOnly")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("Permission", "State", "CreatedAt");

                    b.ToTable("action_items", "app", t =>
                        {
                            t.HasCheckConstraint("CK_action_items_assignment", "(\"AssigneeId\" IS NULL) <> (\"Permission\" IS NULL)");
                        });
                });
