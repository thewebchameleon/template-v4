...
public static class CustomerBillingModel
{
    ...
    {
        model.Entity<CustomerRow>(e => { e.ToTable("customers", "organisations", t => t.HasCheckConstraint("CK_organisation_singleton", "\"Id\" = '00000000-0000-0000-0000-000000000001'::uuid")); e.HasKey(x => x.Id); e.Property(x => x.Name).HasMaxLength(120); e.Property(x => x.Version).IsConcurrencyToken(); e.HasData(new CustomerRow { Id = TemplateV4.Application.Customers.Organisation.Id, Name = "Organisation", Version = new Guid("d473876e-a68f-4d80-8c97-ccdddcddbcdb") }); });
