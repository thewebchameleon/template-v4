...
public sealed partial class InvoicingStore(FrameworkDb db, IOrganisationOperations access, ICrmCustomers crm, TimeProvider time) : IInvoicing
{
    ...
    private Task Lock(CancellationToken ct) => CustomerAccess.MutationLock(db, ct);
