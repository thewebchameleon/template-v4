...
public sealed class SecurityService(FrameworkDb db, UserManager<AppUser> users, IDataProtectionProvider protection, TimeProvider time, IEventOutbox outbox, Microsoft.AspNetCore.Http.IHttpContextAccessor http, IConfiguration config)
{
