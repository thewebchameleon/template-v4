...
public enum EmailTemplate { Verification, PasswordReset, SecurityNotification, Notification, MfaCode, SupportTicket, OrganisationInvitation, RegistrationApproved, RegistrationRejected, ContactEnquiry }
