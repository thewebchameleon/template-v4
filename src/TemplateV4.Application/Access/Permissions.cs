...
public static partial class Permissions
{
    ...
    public static readonly string[] All = [Read, Manage, Roles, ApiKeysManage, Jobs, Settings, SupportAgent, SupportAdmin, InvoiceIssue, InvoiceSettle, InvoiceCorrect, CmsEdit, ContactManage, CrmManage, SharedFilesManage, FileStoragePurge, CommercialBillingRead, CommercialBillingManage];
}
