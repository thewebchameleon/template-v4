...
public sealed record ContactSubmission(string Name, string Email, string Message, string Website = "");
...
{
    Task<Result<Guid>> Submit(ContactSubmission request, CancellationToken ct);
