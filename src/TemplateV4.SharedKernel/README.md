...
Treat namespace/type names, error codes, dispatcher ordering and serialized persisted responses as compatibility contracts. Version packages independently of a consuming application. See `documentation/docs/architecture.md` in the repository for package and compatibility boundaries.
