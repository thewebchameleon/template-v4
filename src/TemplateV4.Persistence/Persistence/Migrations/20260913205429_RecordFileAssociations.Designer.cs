...
namespace TemplateV4.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260913205429_RecordFileAssociations")]
    partial class RecordFileAssociations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TemplateV4.Infrastructure.Crm.CrmAttachmentRow", b =>
                {
                    ...
                    b.HasKey("OrganizationId", "RecordId", "FileId");
            ...
            modelBuilder.Entity("TemplateV4.Infrastructure.Crm.CrmNoteRow", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "RecordId", "At");
            ...
            modelBuilder.Entity("TemplateV4.Infrastructure.Crm.CrmRecordRow", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "Kind", "Archived", "Name", "Id");
            ...
            modelBuilder.Entity("TemplateV4.Infrastructure.Invoicing.CommercialDocumentRow", b =>
                {
                    ...
                    b.HasIndex("OrganizationId", "IssuedAt", "Id");

                    b.HasIndex("OrganizationId", "OriginModule", "OriginType", "OriginId")
                        .IsUnique()
            ...
            modelBuilder.Entity("TemplateV4.Infrastructure.Crm.CrmNoteRow", b =>
                {
                    b.HasOne("TemplateV4.Infrastructure.Crm.CrmRecordRow", null)
                        .WithMany()
                        .HasForeignKey("OrganizationId", "RecordId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
