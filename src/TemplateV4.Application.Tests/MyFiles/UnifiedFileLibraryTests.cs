...
namespace TemplateV4.Application.Tests.MyFiles;
...
public sealed class UnifiedFileLibraryTests
{
    ...
    public async Task Merge_preserves_objects_and_folders_and_enforces_shared_access_and_quota()
    {
        ...
        var service = new MyFilesService(db, storage, TimeProvider.System, new NoSubscription());
        ...
        async Task<bool> Reserve(string name)
        {
            ...
            return (await new MyFilesService(concurrentDb, storage, TimeProvider.System, new NoSubscription())
