...
public sealed class SupportCategoriesStore(SupportDb db, SupportTicketContext tickets, AccessManagementService access, IExecutionContext context, TimeProvider time) : ISupportCategories
{
