...
import { CommercialDetail } from '../../../../../../src/TemplateV4.Angular/src/app/api/models';
...
@Component({
  ...
  template: ` <app-page-header title="invoicing" description="immutableDocument"
    ...
    >
    <app-page-state [state]="data.state()" [refreshError]="data.refreshError()" (retry)="load()" skeleton="detail">
