...
export function discover(root, selection = selectedIds(root)) {
  ...
  const directory = fs.existsSync(compiled) ? compiled : path.join(root, "business-modules");
  const modules = [];
