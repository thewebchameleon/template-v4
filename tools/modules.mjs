...
export function generateModuleIds(root, manifest, check = false) {
  ...
  const runtimeConfigurableModules = definitions.filter(x => x.runtimeConfigurable).map(x => x.id).sort();
